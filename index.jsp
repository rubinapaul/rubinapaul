...
.visual-hidden{
 ...
 display:none!important;
    ...
    <title>John Paul Ministry</title>
</head>
...
body.theme-uhc-mir .header .brandandnavigation .brand>.container li{
...
<div class="container safariCss">
    ...
    <label for="uhglogo" class="hidden"></label>
    ...
    <div class="top-menu">
        <ul class="menu-links">
                ...
                <li>Reconcilling back to Heavenly Father.</li>
			    ...
			    <li class="desktop-only">
				    ...
				    <li class="expandable">
						<div class="link-wrapper">
						    ...
						    <span itemprop="name" style="color: #ffffff;">Blogs</span>
							</a>
						</div>
					</li>
				 ...
				 <li class="expandable">
				    ...
				    <li class="expandable">
						<div class="link-wrapper">
						<a itemprop="url" id="ghn_lnk_3" href="#" rel="#subnav_3" dtmid="acq_top_nav" dtmname="Top Nav:Medicare Education">
							    <span itemprop="name" style="color: #ffffff;">About Us</span>
							</a>
						</div>
					</li>
...
<div class="module module-type-1">
    <div class="container">
              <div itemtype="http://schema.org/Brand" itemscope="itemscope" class="blurb">
...
<table role="presentation" class="align-center" id="colhowdoesthiswork_dce">
                <tbody><tr>
                  <td>
                      		...
                      		<img alt=" " src="images/HowGreatThouArt1.jpg"/>
...
<li rule="" class="linksCond"><a itemprop="url" class="" id="gf_lnk_1" href="#" dtmid="acq_footer" dtmname="Footer:Home"><span itemprop="name">Home</span> <span class="visual-hidden">- in footer section</span></a></li>
  <li rule="" class="linksCond"><a itemprop="url" class="" id="gf_lnk_2" href="#" dtmid="acq_footer" dtmname="Footer:About Us"><span itemprop="name">Blogs</span> <span class="visual-hidden">- in footer section</span></a></li>
   <li rule="" class="linksCond"><a itemprop="url" class="" id="gf_lnk_3" href="#" dtmid="acq_footer" dtmname="Footer:Contact Us"><span itemprop="name">Study</span> <span class="visual-hidden">- in footer section</span></a></li>
 <li rule="" class="linksCond"><a itemprop="url" class="" id="gf_lnk_4" href="#" dtmid="acq_footer" dtmname="Footer:Site Map"><span itemprop="name">EveryDay Walk Map</span> <span class="visual-hidden">- in footer section</span></a></li>
  <li rule="" class="linksCond"><a itemprop="url" class="" id="gf_lnk_5" href="#" dtmid="acq_footer" dtmname="Footer:Privacy Policy"><span itemprop="name">About us</span> <span class="visual-hidden">- in footer section</span></a></li>
         
  </ul>
	
    <div style="width:100%">
		<span style="float:left">&copy;2017</span><span itemprop="name" style="float:left">&nbsp;John Paul Ministries</span> 
		<span style="display: inline"> All rights reserved.</span>
		<span style="float:left"></span>
    </div>
    
     <span class="updated clrspan" style="float: left; width: 100%;">Last updated: 04.19.2018 at 12:01 AM CT</span>
</div>
...
<input type="hidden" class="pageQueryString" value="null" />
